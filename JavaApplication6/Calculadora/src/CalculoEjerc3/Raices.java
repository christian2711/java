 ...
 * igual que 0.  Método obtenerRaices(): llama a tieneRaíces() y si devolvió́
 * true, imprime las 2 posibles soluciones.  Método obtenerRaiz(): llama a
 * tieneRaiz() y si devolvió́ true imprime una única raíz. Es en el caso en que
 * se tenga una única solución posible.  Método calcular(): esté método llamará
 * tieneRaices() y a tieneRaíz(), y mostrará por pantalla las posibles
 ...
 * existir solución, se mostrará un mensaje.
 *
